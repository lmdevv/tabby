...
export function BaseCard({
  ...
  const displayTitleTruncated = truncateText(displayTitle, MAX_TITLE_CHARS);
  const displayUrlTruncated = truncateText(displayUrl, MAX_URL_CHARS);
  ...
  return (
    <ContextMenu>
      ...
      {renderContextMenu && <ContextMenuContent>{renderContextMenu()}</ContextMenuContent>}
    </ContextMenu>
  );
}